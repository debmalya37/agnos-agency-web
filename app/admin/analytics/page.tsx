      ...
      <div className="rounded-3xl border border-slate-800/70 bg-slate-900/70 p-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="grid h-12 w-12 place-items-center rounded-2xl bg-indigo-400/20 text-indigo-200">
              <BarChart3 size={22} />
            </div>
            <div>
              ...
              <h2 className="text-2xl font-semibold">Attribution & BI</h2>
            </div>
          </div>
          <Link
            href="/admin"
        ...
        <div className="mt-6 rounded-2xl border border-slate-800/60 bg-slate-950/40 p-5 text-sm text-slate-300">
          <p className="font-semibold text-slate-200">
            Analytics templates are ready for your data warehouse.
          </p>
          <p className="mt-2 text-slate-500">
            Connect GA4, CRM, and ad platform sources to surface multi-touch
            attribution, cohort retention, and LTV reporting.
          </p>
        </div>
      </div>
    </div>
